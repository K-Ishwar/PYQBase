...
export function ExamQuestionList({ examId, years }: ExamQuestionListProps) {
  ...
  const { data, isFetching, isError } = useQuery<any>({
    queryKey: ['exam-questions', examId, selectedYear, offset],
    queryFn: async () => {
  ...
  return (
    <div className="space-y-8">
      {/* Year Filter */}
      <div>
        <h3 className="text-xl font-bold tracking-tight mb-4">Filter by Year</h3>
