  ...
  return (
    <div className="container py-16 md:py-32 max-w-6xl mx-auto space-y-32">
      ...
      <section className="flex flex-col items-center text-center space-y-8 relative">
        <div className="relative z-10 space-y-8 flex flex-col items-center animate-in fade-in zoom-in duration-500">
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-4 py-8 border-y border-border/50">
      ...
      <section className="space-y-12 pt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="liquid-glass rounded-3xl p-8 space-y-6 hover:border-primary/50 transition-colors">
          ...
          <div className="liquid-glass rounded-3xl p-8 space-y-6 hover:border-secondary/50 transition-colors">
          ...
          <div className="liquid-glass rounded-3xl p-8 space-y-6 hover:border-green-500/50 transition-colors">
          ...
          <div className="liquid-glass rounded-3xl p-8 space-y-6 hover:border-orange-500/50 transition-colors">
      ...
      <section className="space-y-16 pt-8 pb-16">
